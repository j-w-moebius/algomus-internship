...
class Melody1(ur.ItemMarkov):
    ...
    TRANSITIONS = {
        'c':  {                       'c': 0.20, 'd': 0.30, 'g': 0.30 },
        'd':  {            'c': 0.30, 'd': 0.20, 'e': 0.10, 'g': 0.10,  'a': 0.20, "c'": 0.10 },
        'e':  { 'c': 0.10, 'd': 0.30, 'e': 0.20, 'f': 0.30, 'g': 0.10,  "b": 0.10  },
        'f':  { 'c': 0.10, 'd': 0.10, 'e': 0.30, 'f': 0.20, 'g': 0.30, "c'": 0.20, "d'": 0.10},
        'g':  { 'c': 0.10, 'f': 0.30, 'g': 0.20, 'a': 0.30, 'c': 0.10,  "d'": 0.10 },
        'a':  { 'e': 0.30, 'f': 0.10, 'g': 0.30, 'a': 0.20, 'b': 0.30, "d'": 0.10 },
        'b':  { 'g': 0.10, 'a': 0.30, 'b': 0.20, "c'": 0.30, "d'": 0.10 },
        "c'": { 'g': 0.30, 'a': 0.10, 'b': 0.30, "c'": 0.20, "d'": 0.30,  },
